...
_IMAGENET_WORDNETID_TO_CLASSIDX: dict[str, int] = {
    "n01440764": 0,
    "n01443537": 1,
    "n01484850": 2,
    "n01491361": 3,
...
def get_mappings() -> dict[str, int]:
    ...
    """
    # Returning the static dictionary directly is safe, as the original returned a new dict each call.
    # But to fully preserve behavioral contract in case users mutate the returned dict,
    # we must continue returning a fresh dict each time.
    return dict(_IMAGENET_WORDNETID_TO_CLASSIDX)
